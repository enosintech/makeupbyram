...
const Highlights = ({ scrollPosition, height }) => {
  ...
  return (
    <div className="overflow-x-hidden">
        <div ref={slider} style={{height: height}} className="md:w-[200vw] w-[400vw] bg-white text-white md:min-w-[200vw] min-w-[400vw] h-full flex gap-x-1 py-1 moveLeft relative z-50">
