...
const Contact = ({ scrollPosition }) => {
  ...
  return (
    <section style={{height: window.innerHeight * 3}} className="w-full threeVh bg-black -mt-2 flex flex-col relative z-10 overflow-x-hidden">
        <div ref={contactRef} style={{ height: window.innerHeight }} className="w-full oneVh border-b-8 border-white bg-black contactPin relative z-[60] overflow-hidden">
