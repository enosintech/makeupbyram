...
const About = ({ scrollPosition }) => {
  ...
  return (
    ...
    <section id="aboutAnimateTrigger" className="w-full h-[400svh] flex flex-col">
        <div ref={aboutRef} className="w-full h-[100svh] relative bg-white flex flex-col py-1 aboutPin z-20">
        ...
        <div ref={workedWithRef} className="workedWithPin w-full h-[100svh] text-white relative z-10 flex flex-col items-center justify-center">
