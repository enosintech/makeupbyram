...
const Contact = ({ scrollPosition }) => {
  ...
  return (
    <section className="w-full bg-black h-[300dvh] -mt-2 flex flex-col relative z-10 overflow-x-hidden">
        <div ref={contactRef} className="w-full h-[100dvh] border-b-8 border-white bg-black contactPin relative z-[60] overflow-hidden">
        ...
        <div ref={lastPinRef} className="w-full h-[100dvh] lastPin flex items-center justify-center relative whiteScrubTrigger">
            <div ref={contactOverlayRef} className="contactOverlay h-[100dvh] w-[100vw] fixed z-50 left-0 top-0 flex flex-col items-center justify-center gap-y-4">
