...
const Contact = ({ scrollPosition, browserName }) => {
  ...
  return (
    <section style={{height: browserName !== "Safari" || browserName !== "Chrome" ? window.innerHeight * 3 : "300lvh"}} className="w-full bg-black -mt-2 flex flex-col relative z-10 overflow-x-hidden">
        <div style={{height: browserName !== "Safari" || browserName !== "Chrome" ? window.innerHeight : "100lvh"}} className="w-full border-b-8 border-white bg-black contactPin relative z-[60] overflow-hidden">
        ...
        <div style={{height: browserName !== "Safari" || browserName !== "Chrome" ? window.innerHeight : "100lvh"}} className="w-full lastPin flex items-center justify-center relative whiteScrubTrigger">
            <div style={{height: browserName !== "Safari" || browserName !== "Chrome" ? window.innerHeight : "100lvh"}} ref={contactOverlayRef} className="contactOverlay w-[100vw] fixed z-50 left-0 top-0 flex flex-col items-center justify-center gap-y-4">
