...
const Work = ({ scrollPosition }) => {
  ...
  return (
    <section className='w-full h-[850dvh] relative z-30 flex flex-col'>
      ...
      <div className="w-full h-[130dvh] md:px-14 xl:px-28 px-1 relative bg-black flex parallaxTrigger lipsOpacityTrigger z-20 overflow-visible">
        <div className="w-1/2 h-[100dvh] flex justify-center z-10">
        ...
        <div className="w-1/2 h-[100dvh] flex items-end justify-center z-10 relative">
