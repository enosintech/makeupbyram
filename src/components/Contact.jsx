...
const Contact = ({ scrollPosition }) => {
  ...
  return (
    <section style={{height: height ? height * 3 : "300vh"}} className="w-full bg-black -mt-2 flex flex-col relative z-10">
        <div ref={contactPinRef} style={{height: height ? height : "100vh"}} className="w-full border-b-8 border-white bg-black contactPin relative z-[60] overflow-hidden">
        ...
        <div ref={lastPinRef} style={{height: height ? height : "100vh"}} className="w-full lastPin flex items-center justify-center relative whiteScrubTrigger">
            <div ref={contactOverlayRef} style={{height: height ? height : "100vh"}} className="contactOverlay w-[100vw] fixed z-50 left-0 top-0 flex flex-col items-center justify-center gap-y-4">
