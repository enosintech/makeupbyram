...
const Contact = ({ scrollPosition, height }) => {
  ...
  return (
    <section style={{height: height * 3}} className="w-full bg-black -mt-2 flex flex-col relative z-10 overflow-x-hidden">
        <div ref={contactRef} style={{height: height}} className="w-full border-b-8 border-white bg-black contactPin relative z-[60] overflow-hidden">
        ...
        <div ref={lastPinRef} style={{height: height}} className="w-full lastPin flex items-center justify-center relative whiteScrubTrigger">
            <div style={{height: height}} ref={contactOverlayRef} className="contactOverlay w-[100vw] fixed z-50 left-0 top-0 flex flex-col items-center justify-center gap-y-4">
