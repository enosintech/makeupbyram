...
const Contact = () => {
  ...
  return (
    <section className="w-full h-[300svh] -mt-2 flex flex-col relative z-10">
        <div className="w-full h-[100svh] border-b-8 border-white bg-black contactPin relative z-[60] overflow-hidden">
                ...
                <div className="lg:w-[40%] w-full lg:h-full h-[60%] flex flex-col relative">
                    ...
                    <div className="w-full h-[85%] flex lg:flex-col flex-row">
                        ...
                        <div className="lg:w-full md:w-1/2 lg:h-[45%] w-full h-full flex lg:items-start items-center justify-center px-20 sm:px-36 md:px-14 xl:px-32 lg:pt-5">
                            <p className="2xl:text-3xl sm:text-2xl text-lg text-justify tracking-tight font-medium text-white">My name is Ramsha. <span className="text-neutral-500">I am a makeup artist, i make things up. I make things up. I make things up, makeup artist. I make things up. </span></p>
                        </div>
                    </div>
