...
const Work = ({ scrollPosition, height }) => {
  ...
  return (
    <section style={{height: height * 8.5}} className='w-full relative z-30 flex flex-col'>
      ...
      <div className="w-full h-fit flex-col flex relative pinTrigger gap-1 finalPin">
        <div style={{height: height}} className="w-full flex items-center justify-center relative">
      ...
      <div style={{height: height}} className={`w-full bg-white flex md:flex-row flex-col md:gap-x-1 gap-y-1 md:gap-y-0 pinHigh twoTrigger relative overflow-y-visible`}>
      ...
      <div style={{height: height}} className="w-full growUpTrigger bg-black"></div>
      <div style={{height: height * 1.3}} className="w-full md:px-14 xl:px-28 px-1 relative bg-black flex parallaxTrigger lipsOpacityTrigger z-20 overflow-visible">
        ...
        <div style={{height: height}} className="w-1/2 flex items-end justify-center z-10 relative">
