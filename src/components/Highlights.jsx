...
const Highlights = () => {
  ...
  return (
    <section id="moveLeftTrigger" className="w-full h-[300dvh] bg-white relative z-20 text-white">
        <div className="w-full h-[100dvh] overflow-hidden highlightPin relative">
