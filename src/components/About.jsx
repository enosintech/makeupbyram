...
const About = ({ scrollPosition }) => {
  ...
  return (
    ...
    <section id="aboutAnimateTrigger" style={{height: window.innerHeight * 4}} className="w-full flex flex-col overflow-x-hidden fourVh">
        <div ref={aboutRef} className="w-full oneVh relative bg-white flex flex-col py-1 aboutPin z-20">
        ...
        <div ref={workedWithRef} style={{height: window.innerHeight}} className="workedWithPin w-full oneVh text-white relative z-10 flex flex-col items-center justify-center">
