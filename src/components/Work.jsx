...
const Work = ({ scrollPosition }) => {
  ...
  return (
    <section style={{height: window.innerHeight * 8.5}} className='w-full relative z-30 flex flex-col textPinTrigger'>
      ...
      <div ref={pinHighRef} style={{ height: window.innerHeight }} className={`w-full border-y-4 border-white bg-white flex md:flex-row flex-col md:gap-x-1 gap-y-1 md:gap-y-0 pinHigh twoTrigger relative overflow-y-visible`}>
