...
const About = ({ scrollPosition }) => {
  ...
  return (
    ...
    <section id="aboutAnimateTrigger" className="w-full h-[400lvh] flex flex-col">
        ...
        <div ref={workedWithRef} className="workedWithPin w-full h-[100lvh] text-white relative z-10 flex flex-col items-center justify-center">
