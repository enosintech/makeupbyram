...
const About = ({ scrollPosition }) => {
  ...
  return (
    ...
    <section id="aboutAnimateTrigger" style={{height: window.innerHeight * 4}} className="w-full flex flex-col overflow-x-hidden fourVh">
        ...
        <div ref={workedWithRef} style={{height: window.innerHeight}} className="workedWithPin w-full h-[25%] text-white relative z-10 flex flex-col items-center justify-center">
