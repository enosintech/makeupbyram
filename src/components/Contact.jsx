...
const Contact = ({ scrollPosition }) => {
  ...
  return (
    <section className="w-full h-[300vh] bg-black -mt-2 flex flex-col relative z-10">
        ...
        <div ref={lastPinRef} className="w-full h-[100vh] lastPin flex items-center justify-center relative whiteScrubTrigger">
