...
const Work = ({ scrollPosition }) => {
  ...
  return (
    <section style={{height: window.innerHeight * 8.5}} className='w-full relative z-30 flex flex-col'>
      <div style={{height: window.innerHeight}} className="w-full absolute top-0 left-0">
      ...
      <div className="w-full flex-col flex relative pinTrigger gap-1 finalPin">
        <div style={{height: window.innerHeight}} className="w-full flex items-center justify-center relative">
        ...
        <div style={{height: window.innerHeight * 1.6}} className="w-full relative minusTrigger cursorTrigger">
          <WorkSectionComponent creativeMakeup={creativeMakeup} scrollPosition={scrollPosition} />
        </div>
        <div style={{height: window.innerHeight}} className="w-full relative flex gap-1 zeroTrigger cursorTrigger">
        ...
        <div style={{height: window.innerHeight * 1.6}} className="w-full relative oneTrigger z-10 cursorTrigger">
          <WorkSectionComponent shootMakeup={shootMakeup} scrollPosition={scrollPosition} />
        </div>
      </div>
      <div style={{height: window.innerHeight}} className="w-full bg-white flex md:flex-row flex-col md:gap-x-1 gap-y-1 md:gap-y-0 pinHigh twoTrigger relative overflow-y-visible">
      ...
      <div style={{height: window.innerHeight}} className="w-full growUpTrigger bg-black"></div>
      <div style={{height: window.innerHeight * 1.3}} className="w-full md:px-14 xl:px-28 px-1 relative bg-black flex parallaxTrigger lipsOpacityTrigger z-20 overflow-visible">
        <div style={{height: window.innerHeight}} className="w-1/2 flex justify-center z-10">
