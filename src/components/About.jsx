...
const About = ({ scrollPosition }) => {
  ...
  return (
    ...
    <section id="aboutAnimateTrigger" className="w-full heightbyfour flex flex-col">
        <section ref={aboutRef} className="w-full relative bg-white flex flex-col py-1 aboutPin z-20">
        ...
        <section ref={workedWithRef} className="workedWithPin w-full text-white relative z-10 flex flex-col items-center justify-center">
