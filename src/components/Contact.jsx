...
const Contact = ({ scrollPosition }) => {
  ...
  return (
    <section style={{height: window.innerHeight * 3}} className="w-full bg-black -mt-2 flex flex-col relative z-10 overflow-x-hidden">
        <div ref={contactRef}  style={{height: window.innerHeight}} className="w-full border-b-8 border-white bg-black contactPin relative z-[1001] overflow-hidden">
        ...
        <div ref={lastPinRef} className="w-full h-[100lvh] z-[1000] lastPin flex items-center justify-center relative whiteScrubTrigger sm:border-none border-b-4 border-white">
